                ...
                <div class="card-body">
                    <form method="POST" action=" {{ route('edit', $founditems['id']) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
								<input id="color" value={{ $founditems['color'] }} type="text" class="form-control @error('color') is-invalid @enderror" name="color" value="{{ old('color') }}" required autocomplete="color" autofocus>
                            </div>
                        </div>
